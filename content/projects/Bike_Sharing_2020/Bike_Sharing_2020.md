...
This initial analysis provides a crude picture of  the company's userbase. Some of these result can be readily used for early campaigning, however, to make it successful, the analytics team must work in coordination with the marketing team, providing them base level information about specific stations or cluster whenever required.
